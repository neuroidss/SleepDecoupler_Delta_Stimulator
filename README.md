...
By artificially inducing these slow-wave electrical patterns in awake mice, scientists were able to completely reverse the cognitive damage of sleep deprivation without the subjects ever falling asleep. 

## 📱 The Web App: Audio-Visual Entrainment (AVE)
...
3. **Haptic Feedback (Tactile):** Vibrates the device at 1 Hz (on supported devices) for somatosensory synchronization [DOI: 10.1038/s41598-020-66483-3].
